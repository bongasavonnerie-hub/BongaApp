    ...
    try {
      await _authService.signIn(
        _emailController.text
            .trim(), // .trim() enlève les espaces oubliés en début/fin
        _passwordController.text,
      );
      await _authService.ensureUserProfileExists(); //s'il n'y a pas encore de users/{uid} dans Firebase son profil firestore associé(minimal avce rôle standard)
      ...
      setState(
        () => _erreur = 'Connexion impossible. Vérifiez vos identifiants.',
      );
    } finally {
